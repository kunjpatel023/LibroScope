...
export default function Sidebar({ collapsed, setCollapsed }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col items-center py-4 border-b border-gray-200 dark:border-gray-700 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition"
