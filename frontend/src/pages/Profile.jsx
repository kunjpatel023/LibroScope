...
export default function Profile() {
  ...
  return (
    <div className="bg-[#FAF8F3] min-h-screen p-4 sm:p-6 md:m-8 rounded-3xl">
      <div className="max-w-6xl mx-auto bg-white rounded-3xl p-4 sm:p-8 shadow-lg">
        <h1 className="text-2xl sm:text-3xl font-bold mb-8 text-center">Profile</h1>

        {/* Top Profile Card */}
        <div className="flex flex-col md:flex-row items-center bg-gradient-to-r from-purple-100 to-indigo-100 p-4 sm:p-6 rounded-2xl shadow mb-8 w-full">
          <div className="w-20 h-20 sm:w-28 sm:h-28 bg-gradient-to-br from-purple-400 to-indigo-500 rounded-full flex items-center justify-center text-2xl sm:text-3xl text-white font-bold mb-4 md:mb-0 md:mr-6">
            {profile.user.username[0].toUpperCase()}
          </div>
          ...
          <div className="flex-1 text-center md:text-left w-full">
            {editMode ? (
              ...
              <>
                ...
                <button
                  onClick={() => setEditMode(true)}
                  className="px-4 py-2 bg-purple-500 text-white rounded mt-3 w-full sm:w-auto"
                >
                  Edit Profile
                </button>
              </>
              ...
              history.map((h, i) => (
                ...
                >
                  <img
                    src={fixImageUrl(h.book.image)}
                    alt={h.book.title}
                    className="w-16 h-20 object-cover rounded mb-2 sm:mb-0 sm:mr-3"
                  />
