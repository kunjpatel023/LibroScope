...
//         {/* Book Details */}
//         <div className="flex gap-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
//           <img src={book.image_url} alt={book.title} className="w-56 rounded-xl shadow-lg" />
//           <div>
...
//             </button>
//           </div>
//           <Document file={book.pdf_url} onLoadSuccess={onDocumentLoadSuccess}>
...
// Try to import react-pdf safely
...
try {
  ...
  // Fallback if react-pdf not installed
  Document = null;
  Page = null;
}
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex gap-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
          ...
          <div className="flex-1">
            <h2 className="text-3xl font-bold">{book.title}</h2>
            <p className="text-gray-500 dark:text-gray-400 mb-4">by {book.author}</p>
            {/* Optional: description/summary if added later */}
          </div>
        </div>
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
          {book.pdf ? (
            Document && Page ? (
              ...
              // Fallback viewer if react-pdf not installed
